...
+ (NSMutableArray *)decodePoints:(NSString *)encodedString withType:(int)encryptedType {
    ...
    if(encryptedType == VMSEncryptDistancePoint) {
        VTMLatLng *pt = [[VTMLatLng alloc] init];
        ...
        if (isSetPoint) {
            ...
            [points addObject : pt];
            int latOff, lonOff;
            VTMLatLng *ptOld = [[VTMLatLng alloc] init:pt];
            while (index < len) {
        ...
        while (index < len) {
            ...
            VTMLatLng *pt = [[VTMLatLng alloc] initWithLat:(lat * precision) lng:(lng * precision)];
            [points addObject : pt];
        }
    }
